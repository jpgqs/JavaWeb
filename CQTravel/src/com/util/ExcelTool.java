...
public class ExcelTool {
	...
	public static int importHotelInfo(File file) throws Exception {
		
		String[] hotel_info={"id","location","name","address","description","checkin","tips","comment","price","roomtype","view","headpicture"};
		DataStore ds=getData(file, hotel_info);
	...
	public static int importViewInfo(File file) throws Exception {
		
		String[] view_info={"id","location","name","address","description","checkin","comment","price","headpicture"};
		DataStore ds=getData(file, view_info);
